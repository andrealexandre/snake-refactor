...
import snake.utils.FCons
import snake.utils.FList
import snake.utils.FNil
import snake.views.SnakeNodeView
...
class Game(private val onChangeListener: OnChangeListener, private val matrix: GameMatrix, private val rat: Rat, config: GameConfiguration?) {
    private val pointSpace: PointSpace = PointSpace(Range(matrix.width), Range(matrix.height))
    ...
    fun restart() {
        snakeList.foreach { matrix.removeView(it.model.point) }
