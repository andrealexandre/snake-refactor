...
import snake.models.Game.OnChangeListener
import snake.models.GameMatrix
import snake.models.Rat
...
class GameWindow(windowTitle: String, callerMenu: GameMenu, config: GameConfiguration) : JFrame(windowTitle) {
    private val fileManager: FileManager // Game window shouldn't care about this
    private val callerMenu: GameMenu // GameMenu should be mentioned here, we are creating direct cyclic dependencies
